...
class TrainConfig:
    ...
    dataset: DatasetConfig = field(
        default_factory=DatasetConfig.get_choice_class(DatasetRegistry.PGVLM_PHYSOBJECTS.dataset_id)
    )
    ############ Change PGVLM_PHYSOBJECTS for new dataset
    ...
    wandb_project: str = "pgvla"                                  # Name of W&B project to log to (use default!)
    wandb_entity: str = "prismaticvlm"                          # Name of entity to log under
...
def train(cfg: TrainConfig) -> None:
    overwatch.info("PrismaticVLM Training :: Warming Up")
    ...
    train_dataset, collator = get_dataset_and_collator(
        ...
        padding_side=vlm.llm_backbone.get_tokenizer().padding_side,
